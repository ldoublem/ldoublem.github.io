---
title: 刻度尺选择控件
date: 2016-06-07 22:34
tags: 自定义控件
---
在一些项目中经常遇到横向滑行来选择目标值。
类似下面的效果图

![效果图.png](http://upload-images.jianshu.io/upload_images/1194532-dd672f82e16c3827.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
```
package view;
...
```
![效果.gif](http://upload-images.jianshu.io/upload_images/1194532-6dae20801ef3e4b0.gif?imageMogr2/auto-orient/strip)
[下载代码](https://github.com/ldoublem/selectView)